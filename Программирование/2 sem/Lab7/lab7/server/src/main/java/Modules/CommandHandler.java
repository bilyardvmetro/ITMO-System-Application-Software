...
public class CommandHandler {
    ...
    public synchronized Response help(String strArgument, VehicleModel objArgument){
    ...
    public synchronized Response info(String strArgument, VehicleModel objArgument){
        if (!strArgument.isBlank() || objArgument != null){
            return new Response("Неверные аргументы команды", "" );
    ...
    public synchronized Response show(String strArgument, VehicleModel objArgument){
        if (!strArgument.isBlank() || objArgument != null){
            return new Response("Неверные аргументы команды", "" );
    ...
    public synchronized Response add(String strArgument, VehicleModel objArgument){
        if (!strArgument.isBlank() && objArgument == null){
            return new Response("Неверные аргументы команды", "" );
    ...
    public synchronized Response update(String strArgument, VehicleModel objArgument){
        if (strArgument.isBlank() && objArgument == null){
            return new Response("Неверные аргументы команды", "" );
    ...
    public synchronized Response removeById(String strArgument, VehicleModel objArgument){
        if (strArgument.isBlank() || objArgument != null){
            return new Response("Неверные аргументы команды", "" );
    ...
    public synchronized Response clear(String strArgument, VehicleModel objArgument){
        if (!strArgument.isBlank() || objArgument != null){
            return new Response("Неверные аргументы команды", "" );
            ...
            Stack<Vehicle> collection;
            try {
                collection = collectionService.clear();
            } catch (DBProviderException e) {
                return new Response(e.getMessage(), "");
            }
    ...
    public synchronized Response removeGreater(String strArgument, VehicleModel objArgument){
        if (strArgument.isBlank() || objArgument != null){
            return new Response("Неверные аргументы команды", "" );
    ...
    public synchronized Response reorder(String strArgument, VehicleModel objArgument){
        if (!strArgument.isBlank() || objArgument != null){
            return new Response("Неверные аргументы команды", "" );
    ...
    public synchronized Response history(String strArgument, VehicleModel objArgument){
    ...
    public synchronized Response removeAllByType(String strArgument, VehicleModel objArgument){
        if (strArgument.isBlank() || objArgument != null){
            return new Response("Неверные аргументы команды", "" );
    ...
    public synchronized Response countGreaterThanEnginePower(String strArgument, VehicleModel objArgument){
        if (strArgument.isBlank() || objArgument != null){
            return new Response("Неверные аргументы команды", "" );
    ...
    public synchronized Response filterStartsWithName(String strArgument, VehicleModel objArgument){
        if (strArgument.isBlank() || objArgument != null){
            return new Response("Неверные аргументы команды", "" );
